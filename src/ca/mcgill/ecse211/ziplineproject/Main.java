...
/**
 * Main class of the ECSE211 Zipline Design Project. All constants and hardware
 * devices are initialized here. This class also contains the core game logic.
 * <br>
 * 
 * <p>
 * The goal of the project is to create an autonomous robot capable of playing
 * the game Capture the Flag. The robot is transmitted information about the
 * playing field at the beginning of the game, including its team color,
 * starting location, zipline location, and the color of the target flag it
 * needs to capture.
 * </p>
 * <p>
 * At the start of the game, the robot is placed in the appropriate start corner
 * according to whether it is on the RED or GREEN team. The robot then does
 * ultrasonic localization to orient itself to a suitable angle. After that,
 * light localization is performed in order to reliably determine its <i>x</i>
 * and <i>y</i> coordinates.
 * </p>
 * <p>
 * The robot then navigates to the opponent's side of the field, via the zipline
 * or the shallow crossing, depending on its team color, avoiding any obstacles
 * on the way. The robot searches for the opponent flag in the indicated search
 * zone and captures it by beeping three times. The robot returns to its own
 * start corner using the other method of travel.
 * </p>
 * <p>
 * This entire exercise must be done in no more than 5 minutes. This is an image
 * of the competition supplied by the client:
 * </p>
 * 
 * <pre>
 * <img src="{@docRoot}/doc-files/competition.png" />
 * </pre>
 * 
...
public class Main {
	...
	/** The radius of the robot tire, 2.13 cm. */
	public static final double WHEEL_RADIUS = 2.13;
	/**
	 * The width of the robot, as measured between the left and right wheels,
	 * 14.80 cm.
	 */
	public static final double TRACK = 14.68; // was 14.80, then 15.0, then
												// 15.2. 15.0 was better
	/** The length of one competition floor tile, 30.48 cm. */
	public static final double TILE = 30.48;

	/** The speed used by the robot to travel forward. */
	public static final int FWD_SPEED = 180;
	/** The speed used by the robot to rotate. */
	public static final int ROTATE_SPEED = 120;
	/** The speed used by the robot to traverse the zipline. */
	public static final int TRAVERSE_SPEED = 350;

	/** The <i>x</i> coordinate of the zipline approach. */
	public static int x0 = 0;
	/** The <i>y</i> coordinate of the zipline approach. */
	public static int y0 = 0;
	/** The <i>x</i> coordinate of the zipline. */
	...
	// public static final EV3UltrasonicSensor usSensor = (EV3UltrasonicSensor)
	// sensors[0];
	...
	public static final EV3ColorSensor flagSensor = null; // TODO
															// (EV3ColorSensor)
															// sensors[2];
	...
	/**
	 * The current team color of the robot, based on the information sent by the
	 * Wi-Fi server
	 */
	...
	/**
	 * Sets the team color of the robot based on the information obtained from
	 * Wi-Fi
	 */
	...
	// These methods are for internal testing and are therefore excluded from
	// the API
	/*
	 * public static void dispose(Thread thread) { try { thread.join(); // wait
	 * till thread dies } catch (InterruptedException e) {} }
	 * 
	 * public static void waitForever() { try { Thread.sleep(60*60*1000); }
	 * catch (InterruptedException e) { // TODO Auto-generated catch block
	 * e.printStackTrace(); } }
	 * 
	 * public static void endProgram() { try { throw new Exception(); } catch
